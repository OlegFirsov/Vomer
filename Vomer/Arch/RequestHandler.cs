...
namespace Vomer
{
    public class RequestHandler : IRequestHandler
    {
            ...
            /* string path = request.Url;
             ...
             {                
                 ...
                 try
                 {
                     ...
                     downloadProcess.StartInfo.FileName = path;
        ...
        CefReturnValue IRequestHandler.OnBeforeResourceLoad(IWebBrowser browserControl, IBrowser browser, IFrame frame, IRequest request, IRequestCallback callback)
        {
            ...
            //request.SetReferrer("http://vomer.com.ua", ReferrerPolicy.Default);
            //}
        ...
        bool IRequestHandler.OnResourceResponse(IWebBrowser browserControl, IBrowser browser, IFrame frame, IRequest request, IResponse response)
        {
            ...
            /*
            if (request.Url == "https://vomer.com.ua/ajax/dialogs.php" && request.Method == "POST" && request.ResourceType == ResourceType.Xhr)
            {
            ...
            */
            ...
            if (string.Equals(fileName, "/ajax/dialogs.php", StringComparison.OrdinalIgnoreCase))                
            {
                var postDataElement = request.PostData.Elements.FirstOrDefault();
                //MessageBox.Show(postDataElement.GetBody());                
                if (postDataElement.GetBody().Contains("func=show-new-message"))
                {
                    var resourceHandler = ResourceHandler.FromString(postDataElement.GetBody());
                    ...
                    MessageBox.Show(postDataElement.GetBody() + "  " + text);
                }        
        ...
        {        
            ...
            {
                string str = "file:///" + Uri.EscapeDataString(Form1.AppPath) + "\\ErrorLoad\\index.html";
                browserControl.Load(str);
            }
        }
